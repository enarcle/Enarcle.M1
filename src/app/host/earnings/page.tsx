    ...
    <DashboardLayout>
      <div className="p-6 max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          {[
            { label: 'Total Sales', value: fmt(stats.total), icon: DollarSign, color: '#818cf8' },
            { label: 'Your Payout (80%)', value: fmt(stats.payout), icon: TrendingUp, color: '#4ADE80' },
            { label: 'Tickets Sold', value: stats.tickets, icon: Ticket, color: '#a1a1aa' },
        ...
        {loading ? (
          <div className="space-y-2">{[...Array(4)].map((_, i) => <div key={i} className="h-16 rounded-xl animate-pulse" style={{ background: '#1f2937' }} />)}</div>
