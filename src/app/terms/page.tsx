...
const Section = ({ n, title, children }: { n: number; title: string; children: React.ReactNode }) => (
  <section style={{ marginBottom: 32 }}>
    <h2 style={{ fontFamily: 'Syne,sans-serif', fontWeight: 700, fontSize: 18, color: C.text, marginBottom: 12, display: 'flex', alignItems: 'center', gap: 10 }}>
      <span style={{ fontSize: 13, fontWeight: 700, padding: '2px 8px', borderRadius: 6, background: 'rgba(99,102,241,0.15)', color: C.blue, fontFamily: 'DM Mono,monospace' }}>{n}</span>
      {title}
    </h2>
    ...
    <div style={{ background: C.bg, minHeight: '100vh' }}>
      ...
      <div style={{ maxWidth: 800, margin: '0 auto', padding: '40px 24px 80px' }}>
        ...
        <div style={{ marginBottom: 48 }}>
          ...
          <div style={{ marginTop: 20, padding: '14px 18px', borderRadius: 12, background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(99,102,241,0.2)', color: C.blue, fontSize: 13, fontFamily: 'DM Sans,sans-serif' }}>
            By accessing Enarcle or creating an account, you agree to these Terms. If you don't agree, please don't use the Service.
          </div>
        </div>

        <Section n={1} title="Acceptance of Terms">
          <p>By accessing Enarcle ("the Service") at enarcle.live, downloading our mobile application, or creating an account, you confirm that you have read, understood, and agree to be bound by these Terms of Service. These Terms form a legally binding agreement between you and Enarcle.</p>
        </Section>

        <Section n={2} title="Eligibility">
          <p>You must be at least <strong style={{ color: C.text }}>18 years old</strong> to use Enarcle. By using the Service, you represent that you meet this requirement and are not barred from receiving services under applicable law. If you are using Enarcle on behalf of a business entity, you represent that you have authority to bind that entity to these Terms.</p>
        </Section>
        ...
        <Section n={3} title="Accounts">
          <ul style={{ paddingLeft: 20, display: 'flex', flexDirection: 'column', gap: 8 }}>
            ...
            <li>Notify us immediately at <a href="mailto:enarclehq@gmail.com" style={{ color: C.blue }}>enarclehq@gmail.com</a> of any unauthorized use</li>
        ...
        <Section n={4} title="Host Responsibilities">
          <ul style={{ paddingLeft: 20, display: 'flex', flexDirection: 'column', gap: 8 }}>
            ...
            <li>You retain ownership of your content but grant Enarcle a worldwide, non-exclusive license to stream and distribute it</li>
            <li>No hate speech, illegal activities, spam, or misleading content is permitted</li>
            <li>Revenue split: <strong style={{ color: C.gold }}>Host earns 80%, Enarcle retains 20%</strong> of all ticket sales</li>
        ...
        <Section n={6} title="Payments & Pricing">
          <ul style={{ paddingLeft: 20, display: 'flex', flexDirection: 'column', gap: 8 }}>
            <li>All payments are processed securely via Stripe. Enarcle does not store your card details.</li>
            <li>Event ticket prices are set by hosts. Membership prices are set by Enarcle.</li>
        ...
        <Section n={7} title="Content License">
          <p>You retain full ownership of any content you post, upload, or stream on Enarcle. By submitting content, you grant Enarcle a non-exclusive, worldwide, royalty-free license to:</p>
        ...
        <Section n={8} title="Prohibited Activities">
          <p>You may not use Enarcle to:</p>
          <ul style={{ paddingLeft: 20, marginTop: 10, display: 'flex', flexDirection: 'column', gap: 6 }}>
        ...
        <Section n={13} title="Changes to Terms">
          <p>We may update these Terms from time to time. We will notify you of material changes via email or prominent notice on the Service. Your continued use of Enarcle after changes are posted constitutes acceptance of the updated Terms. You can always find the latest version at enarcle.live/terms.</p>
        </Section>
        ...
        <div style={{ padding: '24px', borderRadius: 16, background: C.card, border: `1px solid ${C.border}`, marginTop: 40 }}>
          ...
          <p style={{ fontSize: 14, color: C.muted, fontFamily: 'DM Sans,sans-serif' }}>
            Contact us at <a href="mailto:enarclehq@gmail.com" style={{ color: C.blue }}>enarclehq@gmail.com</a> — we typically respond within 24 hours.
          </p>
        </div>
