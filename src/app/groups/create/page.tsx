      ...
      <div className="p-6 max-w-lg mx-auto">
        ...
        <form onSubmit={handleSubmit}>
          <div className="rounded-2xl p-5 space-y-4 mb-4" style={{ background: '#1f2937' }}>
              ...
              <div className="flex flex-wrap gap-2">
                {CATEGORIES.map(c => (
                  <button key={c} type="button" onClick={() => setForm({ ...form, category: c })}
                    ...
                    style={{
                      background: form.category === c ? '#818cf8' : '#18181b',
                      color: form.category === c ? '#18181b' : '#a1a1aa',
            ...
            <div className="flex items-center justify-between p-3 rounded-xl" style={{ background: '#18181b' }}>
              <div>
              ...
              <button type="button" onClick={() => setForm({ ...form, is_private: !form.is_private })}
                ...
                style={{ background: form.is_private ? '#818cf8' : '#334155' }}>
